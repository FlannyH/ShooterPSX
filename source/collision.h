...
int sphere_aabb_intersect(const aabb_t* self, sphere_t sphere); // questionable
int sphere_triangle_intersect(const collision_triangle_3d_t* self, sphere_t sphere, rayhit_t* hit); // questionable
