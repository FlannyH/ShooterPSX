...
const static int32_t gravity = -4;
const static int32_t walking_acceleration = 32 / 8;
const static int32_t air_acceleration_divider = 24;
...
const static int32_t walking_drag = 24 / 8;
