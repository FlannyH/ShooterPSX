...
void music_play_sequence(int section) {} // todo: implement this
void music_tick(int delta_time) {} // todo: implement this
void music_set_volume(int volume) {} // todo: implement this
void music_stop(void) {} // todo: implement this