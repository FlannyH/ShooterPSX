...
void bvh_construct(bvh_t* bvh, const file_collision_triangle_3d_t* primitives, const uint16_t n_primitives) {
...
void bvh_from_model(bvh_t* bvh, const collision_model_t* mesh) {
    bvh_construct(bvh, mesh->collision_mesh, mesh->n_triangles);
}
