...
static inline void subdivide_twice_then_add_tex_triangle(const vertex_3d_t* verts, svec2_t* trans_vec_xy, scalar_t* trans_vec_z, int avg_z, int sub2_threshold) {
    ...
    // Add to queue
    add_tex_triangle(trans_vec_xy[0], trans_vec_xy[6], trans_vec_xy[11], vtx0, vtx6, vtx11, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_triangle(trans_vec_xy[11], trans_vec_xy[12], trans_vec_xy[5], vtx11, vtx12, vtx5, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_triangle(trans_vec_xy[5], trans_vec_xy[14], trans_vec_xy[10], vtx5, vtx14, vtx10, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_triangle(trans_vec_xy[10], trans_vec_xy[9], trans_vec_xy[2], vtx10, vtx9, vtx2, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[6], trans_vec_xy[3], trans_vec_xy[11], trans_vec_xy[12], vtx6, vtx3, vtx11, vtx12, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[3], trans_vec_xy[7], trans_vec_xy[12], trans_vec_xy[13], vtx3, vtx7, vtx12, vtx13, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[7], trans_vec_xy[1], trans_vec_xy[13], trans_vec_xy[8], vtx7, vtx1, vtx13, vtx8, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[12], trans_vec_xy[13], trans_vec_xy[5], trans_vec_xy[14], vtx12, vtx13, vtx5, vtx14, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[13], trans_vec_xy[8], trans_vec_xy[14], trans_vec_xy[4], vtx13, vtx8, vtx14, vtx4, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[14], trans_vec_xy[4], trans_vec_xy[10], trans_vec_xy[9], vtx14, vtx4, vtx10, vtx9, avg_z, verts[0].tex_id + tex_id_start, 0);
    ...
    if (max_z >= sub2_threshold) {
        add_tex_triangle(trans_vec_xy[0], trans_vec_xy[1], trans_vec_xy[3], vtx0, vtx1, vtx3, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
        add_tex_triangle(trans_vec_xy[0], trans_vec_xy[3], trans_vec_xy[6], vtx0, vtx3, vtx6, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
        add_tex_triangle(trans_vec_xy[3], trans_vec_xy[1], trans_vec_xy[7], vtx3, vtx1, vtx7, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
        add_tex_triangle(trans_vec_xy[1], trans_vec_xy[2], trans_vec_xy[4], vtx1, vtx2, vtx4, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
        add_tex_triangle(trans_vec_xy[1], trans_vec_xy[4], trans_vec_xy[8], vtx1, vtx4, vtx8, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
        add_tex_triangle(trans_vec_xy[4], trans_vec_xy[2], trans_vec_xy[9], vtx4, vtx2, vtx9, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
        add_tex_triangle(trans_vec_xy[0], trans_vec_xy[2], trans_vec_xy[5], vtx0, vtx2, vtx5, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
        add_tex_triangle(trans_vec_xy[0], trans_vec_xy[5], trans_vec_xy[11], vtx0, vtx5, vtx11, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
        add_tex_triangle(trans_vec_xy[5], trans_vec_xy[2], trans_vec_xy[10], vtx5, vtx2, vtx10, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
    }
...
static inline void subdivide_once_then_add_tex_triangle(const vertex_3d_t* verts, svec2_t* trans_vec_xy, scalar_t* trans_vec_z, const scalar_t avg_z, const int sub1_threshold) {
    ...
    // Draw them
    add_tex_triangle(trans_vec_xy[0], trans_vec_xy[3], trans_vec_xy[5], verts[0], ab, ca, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_triangle(trans_vec_xy[3], trans_vec_xy[1], trans_vec_xy[4], ab, verts[1], bc, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[5], trans_vec_xy[3], trans_vec_xy[2], trans_vec_xy[4], ca, ab, bc, verts[2], avg_z, verts[0].tex_id + tex_id_start, 0);
    ...
    if (max_z >= sub1_threshold) {
        add_tex_triangle(trans_vec_xy[0], trans_vec_xy[1], trans_vec_xy[3], verts[0], verts[1], ab, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
        add_tex_triangle(trans_vec_xy[1], trans_vec_xy[2], trans_vec_xy[4], verts[1], verts[2], bc, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
        add_tex_triangle(trans_vec_xy[2], trans_vec_xy[0], trans_vec_xy[5], verts[2], verts[0], ca, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
    }
}
...
static inline void subdivide_twice_then_add_tex_quad(const vertex_3d_t* verts, svec2_t* trans_vec_xy, scalar_t* trans_vec_z, int avg_z, int sub2_threshold) {
    ...
    // Add to queue
    add_tex_quad(trans_vec_xy[0], trans_vec_xy[9], trans_vec_xy[15], trans_vec_xy[16], vtx0, vtx9, vtx15, vtx16, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[9], trans_vec_xy[4], trans_vec_xy[16], trans_vec_xy[17], vtx9, vtx4, vtx16, vtx17, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[4], trans_vec_xy[10], trans_vec_xy[17], trans_vec_xy[18], vtx4, vtx10, vtx17, vtx18, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[10], trans_vec_xy[1], trans_vec_xy[18], trans_vec_xy[19], vtx10, vtx1, vtx18, vtx19, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[15], trans_vec_xy[16], trans_vec_xy[7], trans_vec_xy[11], vtx15, vtx16, vtx7, vtx11, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[16], trans_vec_xy[17], trans_vec_xy[11], trans_vec_xy[6], vtx16, vtx17, vtx11, vtx6, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[17], trans_vec_xy[18], trans_vec_xy[6], trans_vec_xy[12], vtx17, vtx18, vtx6, vtx12, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[18], trans_vec_xy[19], trans_vec_xy[12], trans_vec_xy[8], vtx18, vtx19, vtx12, vtx8, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[7], trans_vec_xy[11], trans_vec_xy[20], trans_vec_xy[21], vtx7, vtx11, vtx20, vtx21, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[11], trans_vec_xy[6], trans_vec_xy[21], trans_vec_xy[22], vtx11, vtx6, vtx21, vtx22, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[6], trans_vec_xy[12], trans_vec_xy[22], trans_vec_xy[23], vtx6, vtx12, vtx22, vtx23, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[12], trans_vec_xy[8], trans_vec_xy[23], trans_vec_xy[24], vtx12, vtx8, vtx23, vtx24, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[20], trans_vec_xy[21], trans_vec_xy[2], trans_vec_xy[13], vtx20, vtx21, vtx2, vtx13, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[21], trans_vec_xy[22], trans_vec_xy[13], trans_vec_xy[5], vtx21, vtx22, vtx13, vtx5, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[22], trans_vec_xy[23], trans_vec_xy[5], trans_vec_xy[14], vtx22, vtx23, vtx5, vtx14, avg_z, verts[0].tex_id + tex_id_start, 0);
    add_tex_quad(trans_vec_xy[23], trans_vec_xy[24], trans_vec_xy[14], trans_vec_xy[3], vtx23, vtx24, vtx14, vtx3, avg_z, verts[0].tex_id + tex_id_start, 0);
...
static inline void subdivide_once_then_add_tex_quad(const vertex_3d_t* verts, svec2_t* trans_vec_xy, scalar_t* trans_vec_z, const scalar_t avg_z, const int sub1_threshold) {
    ...
    if (max_z >= sub1_threshold) {
        add_tex_triangle(trans_vec_xy[0], trans_vec_xy[1], trans_vec_xy[4], verts[0], verts[1], ab, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
        add_tex_triangle(trans_vec_xy[1], trans_vec_xy[3], trans_vec_xy[5], verts[1], verts[3], bc, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
        add_tex_triangle(trans_vec_xy[3], trans_vec_xy[2], trans_vec_xy[6], verts[3], verts[2], cd, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
        add_tex_triangle(trans_vec_xy[2], trans_vec_xy[0], trans_vec_xy[7], verts[2], verts[0], da, (avg_z + 8), verts[0].tex_id + tex_id_start, 0);
    }
...
static inline void draw_tex_quad3d_fancy(const vertex_3d_t* verts) {
    ...
    if (avg_z < TRI_THRESHOLD_FADE_END) {
        ...
        add_tex_quad(trans_vec_xy[0], trans_vec_xy[1], trans_vec_xy[2], trans_vec_xy[3], verts[0], verts[1], verts[2], verts[3], avg_z, verts[0].tex_id, clut_fade);
        return;
    }
