...
CFLAGS = -Wall -Wextra -std=c11 -Wno-unused-function -Wno-unused-variable -Wno-old-style-declaration -Wno-format -Wno-strict-aliasing
CXXFLAGS = -Wall -Wextra -std=c++20 -Wno-unused-function -Wno-unused-variable -Wno-format
